#ifndef RAYTRACINGCM_MATH_H_
#define RAYTRACINGCM_MATH_H_
...
class RayTracingCMMath
    ...
    public:
	__device__ RayTracingCMMath(int _n):
	calibreur(IntervalF(0.0, PI/2), IntervalF(0.0, 1.0))
	    {
	    this->n = _n;
	    }
	__device__
	    virtual ~RayTracingCMMath(void)
	    {
	    // rien
	    }
